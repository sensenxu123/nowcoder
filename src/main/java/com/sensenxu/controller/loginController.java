...
public class   loginController implements communityConstant {
    ...
    public String login(String username, String password, String code, boolean remMe, Model model, HttpServletResponse response,@CookieValue("kaptchaOwner") String kaptchaOwner){
